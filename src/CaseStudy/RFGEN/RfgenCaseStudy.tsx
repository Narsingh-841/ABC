...
import rfgenImage from "../../assets/casestudy.png";

const RfgenCaseStudyHero: React.FC = () => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p 
              ...
              style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' }}
            >
              Discover how RFgen transformed their business capabilities and achieved remarkable growth through strategic partnership and innovative solutions.
            </p>
          ...
          {/* Right Column - RFgen Image */}
          <div className="flex items-center justify-center">
            <div className="relative">
              <img 
                src={rfgenImage} 
                alt="RFgen Case Study"
...
export default RfgenCaseStudyHero;