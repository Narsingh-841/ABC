...
export default function SalesforceSection() {
  ...
  return (
    <section className="relative min-h-[60vh] bg-[#760060]  overflow-hidden py-24 px-4 sm:px-6 lg:px-8 flex items-center" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <p className="text-base md:text-lg lg:text-xl text-black leading-relaxed mb-12 max-w-3xl mx-auto">
          At CAPABILIQ, we bring together certified Salesforce experts to deliver customized CRM solutions that drive growth and efficiency. Our expertise ensures your business maximizes the full potential of the Salesforce platform.
        </p>
