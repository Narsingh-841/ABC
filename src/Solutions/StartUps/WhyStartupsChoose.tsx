      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-lg overflow-hidden border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 border-b border-gray-300">
            {/* Benefit 01 */}
            <div className="p-6 md:p-8 flex flex-col items-center text-center space-y-4 border-r border-gray-300 md:min-h-60">
            ...
            {/* Benefit 03 */}
            <div className="p-6 md:p-8 flex flex-col items-center text-center space-y-4 md:min-h-60">
              <div className="w-14 h-14 rounded-xl flex items-center justify-center shadow-lg" style={{ backgroundColor: '#760060' }}>
                <span className="text-white text-xl font-bold" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", "San Francisco", sans-serif' }}>
                  {benefits[2].number}
                </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3">
            {/* Benefit 04 */}
            <div className="p-6 md:p-8 flex flex-col items-center text-center space-y-4 border-r border-gray-300 md:min-h-60 justify-center">
              <div className="w-14 h-14 rounded-xl flex items-center justify-center shadow-lg" style={{ backgroundColor: '#760060' }}>
                <span className="text-white text-xl font-bold" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", "San Francisco", sans-serif' }}>
                  {benefits[3].number}
                </span>
            ...
            {/* Center Image */}
            <div className="p-4 md:p-6 flex items-center justify-center border-r border-gray-300 md:min-h-60">
            ...
            {/* Benefit 05 */}
            <div className="p-6 md:p-8 flex flex-col items-center text-center space-y-4 md:min-h-60 justify-center">
              <div className="w-14 h-14 rounded-xl flex items-center justify-center shadow-lg" style={{ backgroundColor: '#760060' }}>
                <span className="text-white text-xl font-bold" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", "San Francisco", sans-serif' }}>
                  {benefits[4].number}
                </span>
