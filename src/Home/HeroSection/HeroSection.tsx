...
const HeroSection = () => {
  ...
  return (
    <section 
      ref={sectionRef} 
      className="relative min-h-0 overflow-hidden py-8 lg:py-22"
      style={{
        background: 'linear-gradient(to bottom, #FFFFFF 0%, #D24B8A 250%)'
      }}
    >
      <style>
        {`
      ...
      {!isMobile && (
        <>
          <div className="absolute -left-12 top-6/8 -translate-y-1/2 w-52 h-52 opacity-80 z-0">
            <img src={Abstractspace} alt="Abstract space design" className="w-full h-full object-contain" />
          </div>
          <div className="absolute -right-4 top-1/9 w-42 h-42 opacity-90 z-0">
      ...
      <div
        ref={contentRef}
        className="max-w-7xl mx-auto px-4 text-center relative z-10 transition-transform duration-100 ease-out sf-pro"
        style={contentStyle}
      >
        <div className={`flex items-center justify-center mb-4 transition-all duration-1000 cursor-pointer hover:scale-105 ${
        ...
        {/* MAIN HEADING */}
        <h1 className={`text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-semibold mb-6 lg:mb-6 leading-tight transition-all duration-1000 delay-300 text-center ${
        ...
        <div className={`mb-6 lg:mb-8 transition-all duration-1000 delay-350 ${
          isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'
        }`}>
          <p className="text-gray-700 font-medium text-base lg:text-lg xl:text-l leading-relaxed max-w-3xl mx-auto">
            Build unstoppable fully-vetted teams 20x faster with CapabilIQ.
          </p>
        </div>

        {/* CTA Button with proper spacing */}
        <div className={`mt-8 lg:mt-10 mb-6 lg:mb-8 transition-all duration-1000 delay-500 ${
          isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'
        }`}>
          <button
        ...
        <div className={`flex items-center justify-center gap-3 lg:gap-4 flex-wrap transition-all duration-1000 delay-600 ${
          ...
          <div className="flex items-center gap-1 lg:gap-2 bg-white px-3 lg:px-5 py-1 lg:py-2 rounded-full shadow-md border-2 border-gray-300 hover:shadow-lg hover:scale-105 transition-all duration-300">
