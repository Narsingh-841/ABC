  ...
  return (
    <section ref={sectionRef} className="relative min-h-[60vh] bg-white overflow-hidden">
      ...
      >
        ...
        <h1 className={`text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-gray-900 transition-all duration-1000 delay-200 ${
          isVisible 
        ...
        <p className={`text-gray-700 text-lg md:text-xl mb-10 font-normal max-w-2xl mx-auto transition-all duration-1000 delay-400 ${
          isVisible 
        ...
        {/* CTA Button with enhanced sliding animation */}
        <div className={`flex justify-center mb-12 transition-all duration-1000 delay-600 ${
          isVisible 
            ? 'opacity-100 translate-x-0 scale-100' 
            : 'opacity-0 translate-x-[-100px] scale-95'
        }`}>
          <button className="bg-gradient-to-r from-pink-500 via-purple-500 to-blue-600 text-white px-10 py-4 rounded-full text-base font-semibold hover:shadow-2xl hover:scale-110 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-purple-300 shadow-lg transform hover:rotate-1">
            Book a Consulting Call
          </button>
        </div>

        {/* Review Badges with enhanced sliding animation */}
        <div className={`flex items-center justify-center gap-6 flex-wrap transition-all duration-1000 delay-800 ${
          isVisible 
            ? 'opacity-100 translate-x-0 scale-100' 
            : 'opacity-0 translate-x-[100px] scale-95'
        }`}>
          <div className="flex items-center gap-2 bg-white px-6 py-3 rounded-full shadow-lg border border-gray-100 hover:shadow-xl hover:scale-105 transition-all duration-300">
