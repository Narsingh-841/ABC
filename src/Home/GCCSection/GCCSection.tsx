      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
          ...
          <div className={`flex flex-col justify-between transition-all duration-1000 delay-200 ${
            ...
            <div>
              <button className="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-8 py-3 rounded-full text-sm font-bold hover:shadow-2xl hover:scale-105 transition-all duration-300 shadow-lg">
