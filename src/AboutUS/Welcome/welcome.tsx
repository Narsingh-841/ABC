    ...
    >
      <div className="max-w-6xl mx-auto px-6 py-12 text-center relative z-10">
        ...
        <div className={`flex items-center justify-center gap-2 mb-6 transition-all duration-1000 ${
          ...
          <div className="text-white px-6 py-2 rounded-full font-semibold text-sm" style={{ backgroundColor: '#760060' }}>
        ...
        {/* Subheading */}
        <p className={`text-gray-800 text-base md:text-lg mb-8 font-normal max-w-3xl mx-auto transition-all duration-1000 delay-400 ${
          isVisible 
        ...
        {/* Review Badges */}
        <div className={`flex items-center justify-center gap-6 flex-wrap transition-all duration-1000 delay-600 ${
          isVisible 
            ? 'opacity-100 translate-y-0 scale-100' 
            : 'opacity-0 translate-y-10 scale-95'
        }`}>
          <div className="flex items-center gap-3 bg-white px-6 py-3 rounded-full shadow-md border border-gray-200 hover:shadow-lg hover:scale-105 transition-all duration-300">
