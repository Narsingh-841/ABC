    ...
    <section ref={sectionRef} className="relative min-h-[60vh] bg-white overflow-hidden">
      ...
      >
        ...
        <div className={`flex items-center justify-center gap-2 mb-12 transition-all duration-1000 ${
          ...
          <div className="bg-purple-700 text-white px-6 py-2 rounded-full font-semibold text-sm">
        ...
        <h1 className={`text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-gray-900 transition-all duration-1000 delay-200 ${
          ...
          The Intelligent <span className="bg-gradient-to-r from-purple-500 via-purple-400 to-pink-500 bg-clip-text text-transparent">Hiring Platform</span>
        </h1>

        {/* Subheading */}
        <p className={`text-gray-700 text-lg md:text-xl mb-10 font-normal max-w-3xl mx-auto transition-all duration-1000 delay-400 ${
          isVisible 
        ...
        <div className={`flex items-center justify-center gap-6 flex-wrap transition-all duration-1000 delay-800 ${
          ...
          <div className="flex items-center gap-3 bg-white px-6 py-3 rounded-full shadow-lg border border-gray-200 hover:shadow-xl hover:scale-105 transition-all duration-300">
      ...
      <div 
        className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[150vw] h-[150vh] rounded-b-[100%]"
        style={{
